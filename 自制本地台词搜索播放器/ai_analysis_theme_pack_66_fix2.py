...
def build_qss(theme_name: str, palette_name: Optional[str] = None, background_image: str = "") -> str:
    ...
    if theme.archetype == 'zhefeng':
        ...
        QFrame#softCard, QGroupBox#softCard, QGroupBox {{
            ...
            border: 1px solid rgba(244, 199, 122, 0.18);
        ...
        QLabel#heroSub, QLabel#muted { color: #D8B47A; }
        QTabWidget::pane {{ border: none; background: transparent; }}
        QTabBar::tab {{
            background: rgba(36, 40, 50, 0.78);
            color: #F3DAB2;
            border: 1px solid rgba(244, 199, 122, 0.20);
            border-radius: 16px;
            padding: 10px 18px;
            margin-right: 8px;
        }}
        ...
        QComboBox QAbstractItemView {{
            ...
            color: #EED2A0;
            border: 1px solid rgba(244, 199, 122, 0.22);
        ...
        QTableWidget {{
            ...
            gridline-color: rgba(244, 199, 122, 0.14);
            border-radius: 14px;
        }}
        QHeaderView::section {{
